            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Import IPM Divvy Card Payments List</h5>
...
export default {
    ...
    methods: {
        ...
        getPayments() {
            ...
            queryString.set('card_type', 'IPM Divvy Card');
        ...
        // edit item
        edit(id) {
            localStorage.setItem('breadCrumbMessage', 'IPM Divvy Card');
