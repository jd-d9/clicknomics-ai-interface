            ...
            <v-row class="ma-0">
                <v-col cols="12" sm="12" md="12" lg="12" class="py-0">
                    <v-breadcrumbs>
                        ...
                        <router-link to="/payment_methods/rm-amex-plum-card" class="d-flex align-center">
                        ...
                        <span>Create</span>
                        <v-spacer />
                        <v-btn to="/payment_methods/rm-amex-plum-card" class="ms-auto ml-2 text-none bg-blue-darken-4 btn_animated" prepend-icon="mdi-keyboard-backspace" >
                            Back
                        </v-btn>
                    </v-breadcrumbs>
                </v-col>
                ...
                <v-col cols="12" sm="12" md="12" lg="12" class="py-0">
                    <v-card class="card_design mb-4">
                        <v-card-title class="d-flex justify-space-between">
                            Create RM AMEX Plum Card Payments
                        </v-card-title>
