                            ...
                            <div class="mt-4">
                                ...
                                <v-window v-model="tabplumactivity">
                                    <v-window-item value="activity">
                                        <v-row class="d-flex align-center justify-end">
                                            <v-col v-if="selected.length > 0" class="font-medium font-weight-normal v_select_design pr-0">
                                                <v-btn @click.prevent="deleteSelected" class="ml-2 text-none bg-red-darken-4 btn_animated" prepend-icon="mdi-delete-empty">
                                                    Remove Selected
                                                </v-btn>
                                            </v-col>
                                    ...
                                    <v-window-item value="reports">
                                        <v-row class="d-flex align-center justify-end">
                                            <v-col cols="12" sm="12" md="4" lg="4" class="font-medium font-weight-normal v_select_design pr-0">
                                                <date-range-picker class="date_picker pt-2" :value="selectedRange" @update:value="updateRangeTwo"></date-range-picker>
                                            </v-col>
                                            <v-col cols="12" sm="12" md="4" lg="4" class="font-medium font-weight-normal v_select_design">
            ...
            if(this.search) {
                const data = this.dataMetrics.filter((val) => {
                    return val.date && val.date.toString().includes(this.search.toLowerCase()) || 
                           ...
                           val.card && val.card.toString().includes(this.search.toLowerCase()) ||
                           val.merchant && val.merchant.toLowerCase().includes(this.search.toLowerCase()) ||
