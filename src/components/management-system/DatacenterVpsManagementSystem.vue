    ...
    <div class="bg-default main-content-height">
            ...
            <v-row class="ma-0">
                <v-col cols="12" sm="12" md="12" lg="12" class="py-0">
                    <v-breadcrumbs>
                        ...
                        <span>Datacenter VPS System </span>
                        <v-spacer />
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Import Datacenter VPS System</h5>
        ...
        <div class="modal fade" id="createUpdateData" tabindex="-1" role="dialog" aria-labelledby="createUpdateDataTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{activityType}} Datacenter VPS System</h5>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            search: '',
            headers: [
                { title: 'Company Name', align: 'start', sortable: false, key: 'company' },
