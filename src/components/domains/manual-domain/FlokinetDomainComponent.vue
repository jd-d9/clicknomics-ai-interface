...
export default {
    ...
    methods: {
        ...
        getDomainList() {
            ...
            axios.get(this.$api + '/domains/flokinetDomains', {
                headers: {
        ...
        deleteData(id) {
            if(confirm("Do you really want to delete?")) {
                this.showLoader = true;
                axios.delete(this.$api + '/domains/flokinetDomains/' + id, {
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: this.getAccessToken()
                    }
        ...
        uploadCsv() {
            this.showLoader = true;
            axios.post(this.$api + '/domains/flokinetDomains/importFlokinetDomainCSV', {
