<template>
    <div>
        <v-layout>
                        ...
                        <v-list-item class="pa-0">
                            <div class="sidebar-contents">
                                ...
                                <div v-for="data in selectedMenu" :key="data" @mouseleave="hideHoveredDropdown">
                                    ...
                                    <!--  :class="{'d-block': showOnClick && data.child.length > 0}" -->
                                    <div class="sidebar-dropdown-menu side_submenuitem">                                        
                                        <div class="sidebar-dropdown-head px-3 py-2">
                                            <p class="mb-0 text-white py-1">{{ data.menu }}</p>
                                        </div>
            ...
            <v-main class="navbar-content pa-0">
                <v-app-bar color="primary" class="navbar_fixed" style="position:relative; width: 100%;left: 0 !important;">
