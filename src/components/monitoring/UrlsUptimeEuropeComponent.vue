...
export default {
  ...
  data() {
      return {
          ...
          urlList: [
              {
                  raw_url:'https://prmsclletrck.com/click.php',
                  certificate_check_enabled:'',
                  certificate_issuer:'R3',
                  certificate_expiration_date:'2023-09-24',
                  uptime_status:'',
                  final_url:'https://th-bst-offers.com/yuanpay',
                  offer_name:'YuanPay Group (CA)',
                  action:'',
              }
          ],
          itemsPerPage: -1,
