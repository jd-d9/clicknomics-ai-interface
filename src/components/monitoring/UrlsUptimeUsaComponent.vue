...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            axios.get(this.$api + '/monitoring/urlUptimeUsa', {
                headers: {
        ...
        addNew() {
            ...
            axios.post(this.$api + '/monitoring/urlUptimeUsa', formData, {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: this.getAccessToken(),
                }
        ...
        deleteData(id) {
            this.showLoader = true;
            axios.delete(this.$api + '/monitoring/urlUptimeUsa/' + id, {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: this.getAccessToken(),
                }
        ...
        deleteSelected() {
            ...
            if(confirmDelete) {
                ...
                axios.post(this.$api + '/monitoring/deleteUSAUrlToMonitorMutipleRows', formData, {
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: this.getAccessToken()
                    }
        ...
        uploadCsv() {
            this.showLoader = true;
            axios.post(this.$api + '/monitoring/importUSMonitorCsv', {
